...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Ajout d'un nouveau fichier </li>
      </ol>
    </nav>
</div><!-- End Page Title -->
<div class="card mt-2">
    <div class="modal-header bg-primary text-white p-2 px-3 d-flex justify-content-center ">
        <b class="fw-bold fs-4 "><i class="fa fa-plus"></i> Ajout d'un nouveau document pour ce standard</b>
    </div>
    <div class="card mt-2">
        <div class="card-body col-lg-11 m-auto">
            <form class="vstack mt-4  gap-2" action="{{ route('personnal.evaluer.store') }}" method="post" enctype="multipart/form-data">
