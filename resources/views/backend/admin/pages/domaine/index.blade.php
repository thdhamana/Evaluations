        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex flex-row justify-content-between m-1">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 text-end">
                    ...
                    <a class="btn btn-primary" href="{{ route('admin.domaine.create')}}"><i class='fa fa-add fw-bold me-1'></i>Add a new domaine</a>
                </div>
                            ...
                            @forelse ($domaines as $k => $domaine)
                                <tr>
                                    ...
                                    <td class="p-1 d-flex gap-1 justify-content-end ">
                                        <a href="{{ route('admin.domaine.edit', $domaine) }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body d-flex flex-column gap-2">
                                                    ...
                                                    <b>Etes-vous sûr de vouloir supprimer ce domaine ???</b>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Non</button>
                                                   <!-- Formulaire de suppression -->
                                                    <form action="{{ route('admin.domaine.destroy', $domaine)}}" method="post">
                                                        @method('delete')
                                                        @csrf
